    ...
    d.extend(L.prototype, {
        ...
        _doKeyPress: function (a) {
            ...
            if (d.datepicker._get(b, "constrainInput")) {
                ...
                var c = String.fromCharCode(
                    a.charCode == I ? a.keyCode : a.charCode
                );
                return (
        ...
        parseDate: function (a, b, c, e) {
            ...
            for (
                var h =
                    ...
                    i = (c ? c.dayNames : null) || this._defaults.dayNames,
                    g =
                        (c ? c.monthNamesShort : null) ||
                        this._defaults.monthNamesShort,
                    m = (c ? c.monthNames : null) || this._defaults.monthNames,
                    q = (c = -1),
                    k = -1,
                    l = -1,
                    o = false,
                    ...
                    r = function (p, w, G) {
                        ...
                        for (w = 0; w < p.length; w++)
                            if (
                                b.substr(x, p[w].length).toLowerCase() ==
                                p[w].toLowerCase()
                            ) {
                                x += p[w].length;
                                return w + 1;
                    ...
                    for (
                        ...
                        switch (l[2] || "d") {
                            ...
                            case "M":
                                ...
                                g = Math.min(
                                    g,
                                    d.datepicker._getDaysInMonth(m, q)
                                );
                                break;
                            case "y":
                            case "Y":
        ...
        _generateHTML: function (a) {
            ...
            if (o) {
                ...
                for (
                    j = l && j < l ? l : j;
                    this._daylightSavingAdjust(new Date(n, g, 1)) > j;
            ...
            j = !h
                ...
                : this.formatDate(
                      j,
                      this._daylightSavingAdjust(new Date(n, g - m, 1)),
                      this._getFormatConfig(a),
                      this._yearOffset(a)
                  );
            j = this._canAdjustMonth(a, -1, n, g)
            ...
            f = this._canAdjustMonth(a, +1, n, g)
            ...
            for (
                var G = this._getDefaultDate(a), J = "", D = 0;
                D < i[0];
                D++
            ) {
                for (var M = "", E = 0; E < i[1]; E++) {
                    var N = this._daylightSavingAdjust(
                            new Date(n, g, a.selectedDay)
                        ),
                        t = " ui-corner-all",
                        y = "";
                    if (q) {
                    ...
                    y +=
                        ...
                        t +
                        '">' +
                        (/all|left/.test(t) && D == 0 ? (c ? f : j) : "") +
                        (/all|right/.test(t) && D == 0 ? (c ? j : f) : "") +
                    ...
                    for (var O = 0; O < B; O++) {
                        ...
                        var P = !m
                            ...
                            : '<td class="ui-datepicker-week-col">' +
                              this._get(a, "calculateWeek")(s) +
                              "</td>";
                        for (t = 0; t < 7; t++) {
                            var H = v
                                    ? v.apply(a.input ? a.input[0] : null, [s])
                                    : [true, ""],
                                C = s.getMonth() != g,
                                K =
                                    (C && !w) ||
