						...
						<div class="d-flex flex-column gap-2" style="max-width: fit-content;">
							...
							<div class="d-flex gap-2">
								<div class="btn btn-light position-relative w-100">
									<input type="file" id="file-upload" name="member_img" accept="image/png, image/jpeg" class="position-absolute opacity-0 w-100 h-100" style="top: 0; left: 0; cursor: pointer;">
								...
								<div class="btn btn-light position-relative w-100" style="display: none;">
									<input type="button" id="file-delete" class="position-absolute opacity-0 w-100 h-100" style="top: 0; left: 0; cursor: pointer;">
