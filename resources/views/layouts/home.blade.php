			...
			<nav class="navbar navbar-expand-lg">
				<div class="container-fluid">
					<a class="navbar-brand" href="#">
						<img src="https://coreui.io/docs/assets/brand/coreui-signet.svg" alt="" width="22" height="24" class="d-inline-block align-top">
						CoreUI
					</a>
					...
					<div class="collapse navbar-collapse" id="navbarNavDropdown">
						<ul class="navbar-nav d-flex justify-content-between w-100">
							<div class="d-flex">
								...
								<!-- Item -->
								<li class="nav-item">
									<a class="nav-link active" aria-current="page" href="#">ห้องพักและการจอง</a>
								</li>
								<!-- Item -->
								<li class="nav-item">
									<a class="nav-link active" aria-current="page" href="#">อัตราค่าบริการ</a>
								</li>
								<!-- Item -->
								<li class="nav-item">
									<a class="nav-link active" aria-current="page" href="#">กติกา</a>
								</li>
								<!-- Item -->
								<li class="nav-item">
							...
							<div class="d-flex">
								<!-- Item -->
								<li class="nav-item">
									<a class="nav-link active" aria-current="page" href="register">สมัครสมาชิก</a>
								</li>
								<!-- Item -->
								<li class="nav-item">
